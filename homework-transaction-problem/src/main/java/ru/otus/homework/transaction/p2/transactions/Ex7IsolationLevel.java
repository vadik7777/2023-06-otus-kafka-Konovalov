package ru.otus.homework.transaction.p2.transactions;

import org.apache.kafka.clients.producer.KafkaProducer;
import org.apache.kafka.clients.producer.ProducerConfig;
import org.apache.kafka.clients.producer.ProducerRecord;
import ru.otus.homework.transaction.utils.LoggingConsumer;
import ru.otus.homework.transaction.utils.Utils;

public class Ex7IsolationLevel {
    @SuppressWarnings({"try", "unused", "java:S1192", "java:S1602"})
    public static void main(String[] args) throws Exception {
        Utils.recreateTopics(1, 1, "topic1");

        try (var producerTransactional =
                ...
                var consumerRC =
                        new LoggingConsumer(
                                "ReadCommitted", "topic1", Utils.consumerConfig(), true);
                var consumerRUnC =
                        new LoggingConsumer(
                                "ReadUncommitted", "topic1", Utils.consumerConfig(), false)) {
            ...
            Thread.sleep(500);
            producer.send(new ProducerRecord<>("topic1", "0.1"));

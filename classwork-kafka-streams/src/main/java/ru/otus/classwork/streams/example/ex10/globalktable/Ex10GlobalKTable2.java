...
public class Ex10GlobalKTable2 {
    public static void main(String[] args) throws Exception {
        ...
        countStream
                .leftJoin(companiesTable, (k, v) -> v.getStockTicker(), (summary, company) -> summary.toBuilder().companyName(company).build())
                .leftJoin(clientsTable, (k, v) -> v.getCustomerId(), (summary, client) -> summary.toBuilder().customerName(client).build())

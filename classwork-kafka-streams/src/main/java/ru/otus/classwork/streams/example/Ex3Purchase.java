...
import ru.otus.classwork.streams.service.SecurityDBService;
import ru.otus.classwork.streams.model.purchase.Purchase;
import ru.otus.classwork.streams.model.purchase.PurchasePattern;
import ru.otus.classwork.streams.model.purchase.RewardAccumulator;
...
public class Ex3Purchase {
    public static void main(String[] args) throws Exception {
        ...
        purchaseKStream
                ...
                .selectKey((k, p) -> String.valueOf(p.getPurchaseDate().getTime())) // ** 1

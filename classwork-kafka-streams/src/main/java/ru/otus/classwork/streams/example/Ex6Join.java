...
import ru.otus.classwork.streams.utils.LoggingConsumer;
...
public class Ex6Join {
    public static void main(String[] args) throws Exception {
        ...
        try (
            ...
            Thread.sleep(500);
            producer.send______________________________2(31, "k", "d=1"); // outer: null-c, C-null; left: C-null

            Thread.sleep(500);
            producer.send1(36, "k", "F"); // outer: null-c, C-null; left: C-null

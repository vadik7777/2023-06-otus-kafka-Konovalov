...
public class Main {
    ...
    public static GenericRecord doGenericMethod() {
        ...
        try {
            byte[] bytes = Files.readAllBytes(
                    Paths.get(
                            "classwork-schemaregistry/KafkaAvroSchemaRegistryTODO/src/main/avro/student.avsc"
                    )
            );
    ...
    public static void doReflectMethod() {
        ...
        var avroRecord = new ReflectData.Record(schema);
        avroRecord.put("id", 1);
        avroRecord.put("title", "title");
